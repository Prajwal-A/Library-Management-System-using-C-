...
int main() {
    ...
    cout <<endl<<"Developed By\n"<<endl<<"Name: Prajwal G Alewoor"<<endl<<"Reg No: FA17-BCS-030"<<"\n\n"<<"Name: Karthikeya Mishra"<<endl<<"Reg No: FA17-BCS-020"<<"\n\n"<<"Name: Jinesh Jain"<<endl<<"Reg No: FA17-BCS-010"<<"\n\n";
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 5: {
                ...
                cout << "\nEnter Author Name : ";
                getline(cin, author_name);
                cout<<"Enter Issued Book date:- ";
                cin>>date1;
                cout<<"***** Issued Book should be returned back within 10 days otherwise strict acions would be taken *****"<<endl;
...
bool returnBook(string user_name, string book_name) {
    ...
    cin>>date2;
    int days,fine=0;
    cout<<"**** Fine:- Rs.2 per day (if returned late) ******"<<endl;
    cout<<"enter the number of days the member DELAYED to return the book"<<endl;
    cin>>days;
    if(days>0 && days<=7){
        fine= days * 2;
